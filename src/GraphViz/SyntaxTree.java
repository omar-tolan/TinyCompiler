...
public class SyntaxTree {
	 ...
	 */
	private void makeNode(String label, NodeType type){
	 ...
	 * @return the number of the new node
	 */
	public void makeConstNode(String val){
		makeNode("Const\\n(" + val + ")" , NodeType.EXP);
	}
	 ...
	 * @return the number of the new node
	 */
	public void makeIDNode(String val){
		makeNode("ID\\n(" + val + ")" , NodeType.EXP);
	}
	 ...
	 * @return the number of the new node
	 */
	public void makeOPNode(String val){
		makeNode("OP\\n(" + val + ")" , NodeType.EXP);
	}
	...
	public void makeIFNode(){
		makeNode("if" , NodeType.STATEMENT);
	}
	 ...
	 * @return the number of the new node
	 */
	public void makeRepeatNode(){
		makeNode("repeat" , NodeType.STATEMENT);
	}
	 ...
	 * @return the number of the new node
	 */
	public void makeWriteNode(){
		makeNode("write" , NodeType.STATEMENT);
	}
	 ...
	 * @return the number of the new node
	 */
	public void makeReadNode(String val){
	 ...
	 * @return the number of the new node
	 */
	public void makeAssignNode(String val){
		makeNode("assign\\n(" + val + ")"  , NodeType.STATEMENT);
	}
